...
function Register() {
  ...
  return (
    ...
    <form onSubmit={handleSubmit} autoComplete='off' className='w-[450px] mx-auto mt-[60px]'>
      ...
      <h1 className='font-bold text-[#1DA1F2] text-[42px] mb-[36px]'>Register to Twitter</h1>
      <Input isRequired={true} placeholder={'Phone number, email address'} type={'text'} name={'login'} extraStyle={'mb-[25px]'}/>
      <Input isRequired={true} placeholder={'New Password'} type={'password'} name={'password'} extraStyle={'mb-[25px]'}/>
